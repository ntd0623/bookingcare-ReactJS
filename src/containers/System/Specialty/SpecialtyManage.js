                    ...
                    <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                        ...
                        <div className="bg-blue-600 px-6 py-4">
                            <h2 className="text-xl text-center font-semibold text-white">
                                <FormattedMessage id="manage-specialty.form-title" />
                            </h2>
                        </div>
                        ...
                        <div className="p-6">
                            ...
                            <div className="mb-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                                    <h3 className="text-lg font-medium text-gray-800 mb-4">
                                        <FormattedMessage id="manage-specialty.profile-image" />
                                    </h3>
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <div className="ml-5">
                                            ...
                                            >
                                                <FormattedMessage id="manage-specialty.change-image" />
                                            </button>
                                            <p className="text-sm text-gray-500 mt-2">
                                                <FormattedMessage id="manage-specialty.image-desc" />
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                                    <h3 className="text-lg font-medium text-gray-800 mb-4">
                                        <FormattedMessage id="manage-specialty.cover-image" />
                                    </h3>
                                    ...
                                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    <FormattedMessage id="manage-specialty.upload-cover" />
                                                </span>

                                                <p>
                                                    <FormattedMessage id="manage-specialty.upload-cover-support" />
                                                </p>

                                            </div>

                                            <p className="text-xs text-gray-500">
                                                <FormattedMessage id="manage-specialty.cover-desc" />
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="mb-8">
                                <h3 className="text-lg font-medium text-gray-800 mb-4">
                                    <FormattedMessage id="manage-specialty.basic-info" />
                                </h3>
